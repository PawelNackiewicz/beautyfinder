...
export default async function DynamicPage(props: PageProps) {
  ...
  if (service) {
    ...
    return (
      <StandardPageLayout>
            <h1 className="text-4xl font-serif font-bold mb-4 capitalize">{service.name}</h1>
  ...
  if (city) {
    ...
    return (
      <StandardPageLayout>
            <h1 className="text-4xl font-serif font-bold mb-4 capitalize">Salony w: {city.name}</h1>
            <ListView 
                salons={citySalons} 
      ...
      <StandardPageLayout>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div>
                        <h1 className="text-4xl font-serif font-bold text-foreground mb-2">{salon.name}</h1>
                        ...
                        <div className="prose max-w-none text-muted-foreground">
                            <p>
                                Witamy w {salon.name}! Jesteśmy profesjonalnym salonem {categoryName}, gdzie Twoje piękno jest naszym priorytetem. 
                                Nasz zespół to doświadczeni specjaliści, którzy zadbają o Twój wygląd i samopoczucie. 
                                Zapraszamy do skorzystania z naszych usług w relaksującej atmosferze.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex items-start gap-4 p-4 rounded-xl bg-gray-50">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-gray-600">Pon - Pt: 09:00 - 20:00</p>
