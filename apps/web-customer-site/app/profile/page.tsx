                    ...
                    <CardContent className="w-full flex flex-row items-center justify-between p-6">
                        <div className="flex gap-6 ">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <Typography variant={"cardDescription"} className="text-primary">
                                    Gold Loyalty Member
                                </Typography>
                ...
                <div className="grid grid-cols-3 gap-6">
                    <Card>
                        ...
                        <CardContent className="flex flex-col gap-4">
                            ...
                            <Typography variant={"cardDescription"}>Makijaż permanentny</Typography>
                            <div className="flex gap-2 items-center">
                                <Calendar size={16} />
                    ...
                    <CardContent>
                        ...
                        <Tabs defaultValue="account">
                            <TabsList className="bg-transparent">
                                ...
                                <TabsTrigger value="notification-settings">Ustawienia powiadomien</TabsTrigger>
                            </TabsList>
                            <TabsContent value="appointments">Make changes to your account here.</TabsContent>
                            <TabsContent value="my-vouchers">Change your password here.</TabsContent>
                            <TabsContent value="my-reviews">Change your password here.</TabsContent>
                            <TabsContent value="notification-settings">Change your password here.</TabsContent>
                        </Tabs>
                    </CardContent>
                </Card>
            </main >
