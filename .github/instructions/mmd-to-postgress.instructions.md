...
- [ER Diagram](./docs/db/database.mmd)
- [SQL script](./docs/db/database-script.sql)
...
- If you add indexes, put it near table definition. If you add foreign keys, put it near the table definition as well.
